class ImageurlShare
  ...
  validates :to, format: { with: URI::MailTo::EMAIL_REGEXP, message: 'recipient email address is invalid' }
  validates :from, format: { with: URI::MailTo::EMAIL_REGEXP, message: 'sender email address is invalid' }
